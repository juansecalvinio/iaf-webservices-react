...
function obtenerConsumos(OsId, TipOsId) {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            ...
            pp.PrestPlanPlanComSistExtId as PlanId, true as Acreditado, 1.00 as Cantidad, ACTASISTID as Codigo, false as CodigoEstadoTransaccion,
...
function obtenerProcedimientos(OsId, TipOsId) {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            var procedimientos = [];
...
module.exports = {
    obtenerConsumos: obtenerConsumos,
    obtenerProcedimientos: obtenerProcedimientos
}